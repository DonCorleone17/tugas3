...
<head>
  ...
  <title>BANGSAT.id | Barang dan Jasa Ketapang</title>
...
<body>
  ...
  <header id="header" class="fixed-top bg-dark">
    <div class="container d-flex align-items-center">
      ...
      <h1 class="logo mr-auto"><a href="{{ url('admin/beranda') }}">BANGSAT.id | Barang dan Jasa Ketapang</a></h1>
      <nav class="nav-menu d-none d-lg-block ">
        <ul>
          <li class=><a href="{{ url('/index') }}">Beranda</a></li>
  ...
  <section id="hero" class="d-flex align-items-center justify-content-center">
    <div class="container position-relative">
      <h1>BANGSAT.id | Barang dan Jasa Ketapang</h1>
      <h2>Marketplace Terpercaya Untuk Anda</h2>
    </div>
  </section><!-- End Hero -->
  <main id="main">
    <!-- ======= About Section ======= -->
      ...
      <div class="container">
        ...
        <div class="row">
          ...
          <div class="col-lg-6 pt-4 pt-lg-0">
            ...
            <p>
              Memiliki slot RAM yang dapat di upgrade sampai 8 GB, dan VGA yang tak kalah baik dari Lenovo S400-9039, laptop ini cukup baik jika dimanfaatkan sebagai laptop Gaming kelas menengah.
            </p>
            <div class="row">
              <div class="col-md-6">
    ...
    <section id="team" class="team section-bg">
      <div class="container">
        ...
        <div class="section-title">
          <h2>Yang Tersedia Disini</h2>
          <p>BANGSAT.id (Barang dan Jasa Ketapang), Marketplace Terpercaya Untuk Anda! Kami Juga Menyediakan Berbagai Macam Barang dan Produk dari Berbagai Toko yang Menyediakan serta Jasa-Jasa dari berbagai Sumber.</p>
        </div>
  ...
  <!-- ======= Footer ======= -->
    <div class="container d-md-flex py-4">
      ...
      <div class="mr-md-auto text-center text-md-left">
        <div class="copyright">
          &copy; <strong><span>BANGSAT.id | Barang dan Jasa Ketapang</span></strong>. Hak Cipta Dilindungi
        </div>
        <div class="credits">
